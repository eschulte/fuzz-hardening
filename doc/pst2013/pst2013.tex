...
\title{Fully-automated Proactive Software Hardening using Genprog and Fuzz Testing}
...
\begin{abstract}
%\boldmath
Hardening software to make it more robust and able to withstand atatcks can be
very challenging.  This paper explores a method for automated hardening by
combing an automated bug-finding technique with automated software repair.
\end{abstract}
