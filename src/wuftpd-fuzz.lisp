...
(defvar *test* "../../bin/test-wuftpd.sh"
  "The wu-ftpd test script with fuzzing.")

(defvar *fuzz-test* "../../bin/test-fuzz-wuftpd.sh"
  "Script to run a variant on a fuzz file.")

(defvar *fuzz* "../../bin/break-wuftpd.sh"
  "Script to break wu-ftpd with fuzzing.")
...
(defvar *orig* (from-file (make-instance 'asm) "ftpd_comb.s")
